...
@section('content')
    <x-public.internal-page
        ...
        :force-banner-title-style="in_array($pageKey, ['niveles-educativos', 'modalidad', 'sistema-evaluacion', 'proyectos-pedagogicos', 'calendario-academico', 'zona-academica'], true)"
    >
        <x-slot:sidebar>
