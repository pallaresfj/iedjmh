    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-6">
        <div class="min-w-0 flex items-center gap-3 sm:gap-4">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 text-xs leading-relaxed text-ied-gray-700 sm:text-sm">
